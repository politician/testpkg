/**
 * This configuration is based on the content of commitizen.config.js
...
const {
  ...
  allowCustomScopes,
  upperCaseSubject,
} = require(__dirname + '/cz-config.js')
...
const upperCaseType =
  types[0].value.charAt(0).toUpperCase() === types[0].value.charAt(0)
